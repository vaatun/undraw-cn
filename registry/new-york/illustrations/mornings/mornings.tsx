...
export interface MorningsProps extends SVGProps<SVGSVGElement> {}

export const Mornings = (props: MorningsProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        data-name="Path 2362" fill="#e6e6e6" id="f49d3234-3c8e-421e-8fbc-1882acc2b62b-960"
    ...
    <path
        ...
        data-name="Path 2484" fill="var(--color-primary)"
        id="aa45fc53-812a-4d29-b97e-7f1282d3d680-961" transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 2485" fill="#feb8b8" id="ab28f9f1-3872-4572-9db3-fdc0c2b56930-962"
        transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 2486" fill="var(--color-primary)"
        id="e38d1f50-71d2-4502-a947-37a79b1baefe-963" transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 2487" fill="#feb8b8" id="a4438e3b-f1f0-4fb4-883b-23c73ca92a93-964"
        transform="translate(-58.95203 -158.21149)" />
    <circle cx="568.62999" cy="126.80999" data-name="Ellipse 85" fill="#3f3d56"
        id="b8db2fb6-f3e1-4f6c-8969-65ed1b7fc810" r="71.242" />
    <path
        ...
        data-name="Path 2488" fill="var(--color-primary)"
        id="a8ffa943-ba12-47ea-a3ce-887fe10517d1-965" transform="translate(-58.95203 -158.21149)" />
    <circle cx="561.88999" cy="171.78799" data-name="Ellipse 491" fill="#feb8b8"
        id="b8556b8d-ea4d-44f1-881d-63b03cbd5c82" r="64.502" />
    <path
        ...
        data-name="Path 574" fill="#3f3d56" id="b12de61e-1204-4bc3-8fe3-5af6696e169c-966"
        transform="translate(-58.95203 -158.21149)" />
    <circle cx="580.43297" cy="48.93" data-name="Ellipse 87" fill="#3f3d56"
        id="b3381070-dd63-42ff-a7f2-d7b052b00dac" r="19.854" />
    <path
        d="M669.053,223.78349c-16.186-6.122-43.136-9.226-57-7.1l1.9-13.885c13.33,6.889,40.157,10.127,57,7.1Z"
        data-name="Path 575" fill="var(--color-primary)"
        id="a59edb5f-8afb-4734-b526-6942bc6c3436-967" transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 576" fill="#3f3d56" id="a799e502-b5ec-41bb-ac2d-d7f36e72d183-968"
        transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 577" fill="#3f3d56" id="b966a1bb-b26c-4365-9b42-58e2bab2452b-969"
        transform="translate(-58.95203 -158.21149)" />
    <rect data-name="Rectangle 254" fill="#e6e6e6" height="2"
        id="f9722a62-0ff9-4c04-8bc3-c55c9a508670" width="1082.09595" y="580.58" />
    <path
        ...
        fill="#e6e6e6" transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 776" fill="#e6e6e6" id="aa566eb5-3f42-4528-81f0-de30369d1f39-970"
        transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 777" fill="#e6e6e6" id="abd5ca91-6d07-45db-b5e3-f61f3053fe6d-971"
        transform="translate(-58.95203 -158.21149)" />
    <path
        ...
        data-name="Path 778" fill="#e5e5e5" id="ab90bebd-a5e2-40ec-8bc4-54c2d6be70fa-972"
        transform="translate(-58.95203 -158.21149)" />
    </svg>
  )
}

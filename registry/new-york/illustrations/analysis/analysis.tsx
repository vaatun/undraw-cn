...
export interface AnalysisProps extends SVGProps<SVGSVGElement> {}
...
export const Analysis = (props: AnalysisProps) => {
  return (
    ...
    >
      ...
      <rect fill="#dedfe0" height="2" width="766.47" x="2" y="36.39" />
    <path
        ...
        fill="#dedfe0" />
    <rect fill="#dedfe0" height="2" width="766.47" x="2" y="119.06" />
    <path
        ...
        fill="#dedfe0" />
    <rect fill="#dedfe0" height="2" width="766.47" x="2" y="201.72" />
    <path
        ...
        fill="#dedfe0" />
    <path d="m276,39.39H2c-1.1,0-2-.9-2-2s.9-2,2-2h274c1.1,0,2,.9,2,2s-.9,2-2,2Z"
        fill="var(--color-primary)" />
    <path d="m419.05,122.06H2c-1.1,0-2-.9-2-2s.9-2,2-2h417.05c1.1,0,2,.9,2,2s-.9,2-2,2Z"
        fill="var(--color-primary)" />
    <path d="m139,204.72H2c-1.1,0-2-.9-2-2s.9-2,2-2h137c1.1,0,2,.9,2,2s-.9,2-2,2Z"
        fill="var(--color-primary)" />
    <g>
        <polygon fill="#f3a3a6"
            points="577.06 164.66 560.51 170.3 560.24 146.39 575.31 146.22 577.06 164.66" />
        <circle cx="562.19" cy="136.43" fill="#f3a3a6" r="16.56" />
        <path
        ...
        <g>
            <path
                ...
                fill="#f3a3a6" id="uuid-c8983f9d-ef50-4d77-8f7b-49f8a94dcf30-34" />
            <path
        ...
        <rect fill="#f3a3a6" height="22.07" transform="translate(-4.9 6.36) rotate(-.64)"
            width="15.56" x="559.12" y="430.83" />
        <path
            ...
            fill="#2f2e43" />
        <rect fill="#f3a3a6" height="22.07" transform="translate(-132.35 400.01) rotate(-32.59)"
            width="15.56" x="610.24" y="415.35" />
        <path
        ...
        <path
            ...
            fill="#f3a3a6" id="uuid-97a43cd7-1586-4870-a70d-869ca8f8714f-35" />
        <path

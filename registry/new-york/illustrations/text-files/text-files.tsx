...
export interface TextFilesProps extends SVGProps<SVGSVGElement> {}

export const TextFiles = (props: TextFilesProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="#e6e6e6" transform="translate(-95.53981 -146.27502)" />
    <path
        ...
        fill="#fff" transform="translate(-95.53981 -146.27502)" />
    <path
        ...
        data-name="b9c54412-061c-4155-b289-fb4c23e4a64e" fill="#e6e6e6"
        id="a90d98f2-fe2a-41dc-85de-0aa221261a3e-2418" transform="translate(-95.53981 -146.27502)" />
    <path
    ...
    <path
        ...
        data-name="a7242049-80b4-49e1-bd08-67354734c824" fill="#e6e6e6"
        id="b54624cf-b287-45f0-8f58-93aafc1fcbba-2419" transform="translate(-95.53981 -146.27502)" />
    <path
    ...
    <path
        ...
        data-name="b7a050eb-0cb2-44a8-b642-35d340850eff" fill="#e6e6e6"
        id="a665a07e-790f-4a9c-be99-8c13ca89238c-2420" transform="translate(-95.53981 -146.27502)" />
    <path
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-95.53981 -146.27502)" />
    <path
        d="M343.57782,415.072a3.755,3.755,0,0,0,0,7.50892h99.00454a3.755,3.755,0,1,0,.12329-7.50892q-.06165-.001-.12329,0Z"
        data-name="Path 40" fill="#fff" id="b3cdc3b1-5d0a-4cee-b54c-a38ee088c012-2421"
    ...
    <path
        ...
        data-name="Path 40" fill="#fff" id="b79c0997-055d-434d-8704-cfc1ccad2281-2422"
        transform="translate(-95.53981 -146.27502)" />
    <path
        d="M343.57782,485.51005a3.755,3.755,0,0,0,0,7.50893H539.58236a3.755,3.755,0,1,0,.12329-7.50893q-.06165-.001-.12329,0Z"
        data-name="Path 40" fill="#fff" id="ed7d1f14-d1d4-40af-b9ad-7b5b5ece23df-2423"
        transform="translate(-95.53981 -146.27502)" />
    <path
        d="M343.57782,520.72906a3.755,3.755,0,0,0,0,7.50892H539.58236a3.755,3.755,0,1,0,.12329-7.50892q-.06165-.001-.12329,0Z"
        data-name="Path 40" fill="#fff" id="ba3b747a-a6b2-4f39-a169-6ef4c21cd2ce-2424"
        transform="translate(-95.53981 -146.27502)" />
    <path
        d="M343.57782,555.94807a3.755,3.755,0,0,0,0,7.50892H539.58236a3.755,3.755,0,1,0,.12329-7.50892q-.06165-.00105-.12329,0Z"
        data-name="Path 40" fill="#fff" id="b6e4b743-2497-479e-800a-91c8b21b3df9-2425"
        transform="translate(-95.53981 -146.27502)" />
    <path
        d="M343.57782,591.16708a3.755,3.755,0,0,0,0,7.50892H539.58236a3.755,3.755,0,1,0,.12329-7.50892q-.06165-.00105-.12329,0Z"
        data-name="Path 40" fill="#fff" id="f91f499d-e7c9-446d-84c9-bf78465468f6-2426"
        transform="translate(-95.53981 -146.27502)" />
    <path d="M590.14174,386.874h-38a4,4,0,0,1-4-4v-34h0Z" fill="var(--color-primary)"
        transform="translate(-95.53981 -146.27502)" />
    <path d="M590.14174,386.874h-38a4,4,0,0,1-4-4v-34h0Z" opacity="0.2"
        transform="translate(-95.53981 -146.27502)" />
    </svg>
  )
}

...
export interface FriendshipProps extends SVGProps<SVGSVGElement> {}

export const Friendship = (props: FriendshipProps) => {
  return (
    <svg
    ...
    >
      ...
      <defs>
        <linearGradient gradientTransform="matrix(-1, 0, 0, 1, 967, 0)"
            gradientUnits="userSpaceOnUse" id="d91c7811-87ec-4fc8-aa52-46c2543d8327-2598"
            x1="380.12" x2="530.06" y1="690.08" y2="690.08">
    ...
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-28.88 -59.45)" />
    <circle cx="939.95" cy="375.52" fill="var(--color-primary)" r="102.23" />
    <circle cx="831.23" cy="347.59" fill="var(--color-primary)" r="102.23" />
    <circle cx="711.55" cy="348.59" fill="var(--color-primary)" r="102.23" />
    <circle cx="672.65" cy="375.52" fill="var(--color-primary)" r="102.23" />
    <circle cx="606.82" cy="384.5" fill="var(--color-primary)" r="102.23" />
    <circle cx="579.89" cy="303.71" fill="var(--color-primary)" r="102.23" />
    <circle cx="609.81" cy="209.95" fill="var(--color-primary)" r="102.23" />
    <circle cx="666.66" cy="209.95" fill="var(--color-primary)" r="102.23" />
    <circle cx="699.58" cy="168.06" fill="var(--color-primary)" r="102.23" />
    <circle cx="783.36" cy="213.94" fill="var(--color-primary)" r="102.23" />
    <circle cx="978.85" cy="303.71" fill="var(--color-primary)" r="102.23" />
    <circle cx="920" cy="252.84" fill="var(--color-primary)" r="102.23" />
    <circle cx="882.1" cy="201.97" fill="var(--color-primary)" r="102.23" />
    <circle cx="810.29" cy="125.17" fill="var(--color-primary)" r="102.23" />
    <circle cx="943.94" cy="209.95" fill="var(--color-primary)" r="102.23" />
    <g opacity="0.1">
    ...
    <path d="M918.34,614.12s62.5-52.53,31.58-127.33L919,475.21,885.45,578.5Z" fill="#67647e"
    ...
    <path
        ...
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <ellipse cx="579.5" cy="687.94" fill="var(--color-primary)" opacity="0.1" rx="556.5" ry="93.16" />
    <path
        ...
        fill="var(--color-primary)" transform="translate(-28.88 -59.45)" />
    <path d="M1036.72,603.1s-11.48,24.92,0,45.25,2,77.38-28.53,85.58" fill="none" stroke="#535461"
        stroke-miterlimit="10" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        d="M1072.93,685.33s-23.2-3.69-25.31,17.1S1003,726.1,1003,726.1l.8.53c35.09,23,68.63,14.67,63.57-15.91C1065.5,699.35,1065.65,687.93,1072.93,685.33Z"
        fill="#f5f5f5" opacity="0.2" transform="translate(-28.88 -59.45)" />
    <path d="M1072.93,685.33s-18,4-16.53,20.33-26.74,36-53.39,20.44" fill="none" stroke="#535461"
        stroke-miterlimit="10" transform="translate(-28.88 -59.45)" />
    <path
        ...
        fill="#67647e" transform="translate(-28.88 -59.45)" />
    <g opacity="0.1">
        <path
    ...
    <path
        ...
        fill="#a8a8a8" transform="translate(-28.88 -59.45)" />
    <path
        ...
        opacity="0.2" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        d="M119.35,626.27c15.33,22.63,10.44,103.65,10.44,103.65s-77.05-25.51-92.38-48.13a49.49,49.49,0,0,1,81.95-55.51Z"
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path d="M50.92,613.11S108.66,657.69,130.09,730" fill="none" stroke="#535461"
        stroke-miterlimit="10" transform="translate(-28.88 -59.45)" />
    <path
        d="M144.63,668.57s-41-7-13,60.91c0,0,28.49-10.86,30.71-37.88a21.56,21.56,0,0,0-17.15-22.92Z"
        fill="var(--color-primary)" transform="translate(-28.88 -59.45)" />
    <path d="M145.23,668.5s7.81,37.56-13.56,61" fill="none" stroke="#535461" stroke-miterlimit="10"
        transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        opacity="0.2" transform="translate(-28.88 -59.45)" />
    <circle cx="939.95" cy="352.58" fill="var(--color-primary)" r="102.23" />
    <circle cx="831.23" cy="324.65" fill="var(--color-primary)" r="102.23" />
    <circle cx="711.55" cy="325.65" fill="var(--color-primary)" r="102.23" />
    <circle cx="672.65" cy="352.58" fill="var(--color-primary)" r="102.23" />
    <circle cx="606.82" cy="361.56" fill="var(--color-primary)" r="102.23" />
    <circle cx="579.89" cy="280.77" fill="var(--color-primary)" r="102.23" />
    <circle cx="609.81" cy="187.01" fill="var(--color-primary)" r="102.23" />
    <circle cx="666.66" cy="187.01" fill="var(--color-primary)" r="102.23" />
    <circle cx="699.58" cy="145.12" fill="var(--color-primary)" r="102.23" />
    <circle cx="783.36" cy="191" fill="var(--color-primary)" r="102.23" />
    <circle cx="978.85" cy="280.77" fill="var(--color-primary)" r="102.23" />
    <circle cx="920" cy="229.9" fill="var(--color-primary)" r="102.23" />
    <circle cx="882.1" cy="179.03" fill="var(--color-primary)" r="102.23" />
    <circle cx="810.29" cy="102.23" fill="var(--color-primary)" r="102.23" />
    <circle cx="943.94" cy="187.01" fill="var(--color-primary)" r="102.23" />
    <path d="M1070.61,262.47s-95.21-45.15-152.82,34.87" opacity="0.1"
        transform="translate(-28.88 -59.45)" />
    <path d="M820.53,171s-105.32-3.18-126,93.22" opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path d="M689.61,380.16S594.4,335,536.79,415" opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#ffd037" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#dc9ba3" transform="translate(-28.88 -59.45)" />
    <path
        d="M717.57,786.32s-1,15.66,1,18.26c0,0-45.92,8.35-51.66,5.74s-3.13-6.78,0-8.35,18.79-7.31,20.87-18.26c0,0-6.78-3.13,15.13,1S717.57,786.32,717.57,786.32Z"
        opacity="0.05" transform="translate(-28.88 -59.45)" />
    <path
        d="M896.56,634.46s-5.74,9.39-2.09,27.66-9.39,18.26-9.39,18.26H859l-8.87-23,12.52,1s8.35-2.09,4.7-21.4Z"
        fill="#ffd2d9" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#e9e9ef" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#cedad5" transform="translate(-28.88 -59.45)" />
    <path
        ...
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <circle cx="852.81" cy="565.36" fill="#ffd2d9" r="22.96" />
    <path
        ...
        fill="#844f6e" transform="translate(-28.88 -59.45)" />
    <g opacity="0.05">
    ...
    <path
        ...
        fill="#cedad5" transform="translate(-28.88 -59.45)" />
    <path d="M778.36,755.27A42.39,42.39,0,0,0,766.88,749a41,41,0,0,1-11-5.74" opacity="0.1"
        transform="translate(-28.88 -59.45)" />
    <path
        ...
        fill="#fff" opacity="0.2" transform="translate(-28.88 -59.45)" />
    <path d="M708.07,796.69q-.11.47-.25.93C707.31,797.33,706.58,796.77,708.07,796.69Z" fill="lime"
        opacity="0.05" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="url(#d91c7811-87ec-4fc8-aa52-46c2543d8327-2598)" transform="translate(-28.88 -59.45)" />
    <rect fill="#5f5d7e" height="42.86" transform="translate(1011.23 1431.89) rotate(-180)"
        width="59.84" x="490.14" y="724.24" />
    <path
        ...
        fill="#5f5d7e" transform="translate(-28.88 -59.45)" />
    <path
        d="M535.12,714.9s44.56-9.34,45.83,9.34-26.31,56-26.31,56l-25-5.09,7.21-28.86s-28.43-6.37-30.13-6.79S535.12,714.9,535.12,714.9Z"
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#fdc2cc" transform="translate(-28.88 -59.45)" />
    <path
        d="M530.88,730.18,534,733l2,1.82s10.19,16.55,23.34,6.37S549.13,723.39,544.46,723a5.86,5.86,0,0,1-4.4-3.19,14,14,0,0,1-1.54-4Z"
        opacity="0.05" transform="translate(-28.88 -59.45)" />
    <path
        d="M558.47,785.35s-4.24,8.06-3,11.46-30.13-4.67-30.13-4.67,2.55-9.76,2.12-11S558.47,785.35,558.47,785.35Z"
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path d="M530.88,730.18,534,733c0-5.44,3.61-10.44,6.08-13.25a14,14,0,0,1-1.54-4Z" opacity="0.1"
        transform="translate(-28.88 -59.45)" />
    <path d="M512.21,687.32l29.28,29.28s-10.19,8.91-8.06,18.25l-21.22-23.77Z" fill="#c4c8e2"
        transform="translate(-28.88 -59.45)" />
    ...
    <path
        ...
        fill="#d39999" transform="translate(-28.88 -59.45)" />
    ...
    <path
        ...
        fill="#c4c8e2" transform="translate(-28.88 -59.45)" />
    <path
        d="M509,643c-.47-2.23,3.21,1.13,4.39,3.08l.06.11c1.7,3,.85,2.12,3.4,8.91s-.85,56,3,62a95.5,95.5,0,0,1,6.79,13.16l-6.79-2.55s-2.55-7.64-4.24-9.34-.85-17.4-.85-17.4-1.27-27.16-2.55-33.1C511.2,663.09,510,647.69,509,643Z"
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#4c4c56" transform="translate(-28.88 -59.45)" />
    <path
        ...
        opacity="0.1" transform="translate(-28.88 -59.45)" />
    <path d="M490.35,692.62s2.12,26.74,16.13,32.68" opacity="0.1"
        transform="translate(-28.88 -59.45)" />
    <path
    ...
    <path
        ...
        fill="#865a61" transform="translate(-28.88 -59.45)" />
    </svg>
  )
}

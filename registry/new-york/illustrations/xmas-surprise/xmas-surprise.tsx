...
export interface XmasSurpriseProps extends SVGProps<SVGSVGElement> {}

export const XmasSurprise = (props: XmasSurpriseProps) => {
  return (
    <svg
    ...
    <polygon opacity="0.1" points="721.41 7.04 641.89 83.67 258.58 126.27 190.07 59.1 721.41 7.04" />
    <polygon opacity="0.1"
    ...
    <polygon fill="#373e46" points="194.1 52.39 262.61 119.55 722 68.51 728.72 0 194.1 52.39" />
    <path
        ...
        fill="#eeeff0" transform="translate(-208.1 -44)" />
    <ellipse cx="344.55" cy="211.56" fill="var(--color-primary)" rx="57.09" ry="79.25" />
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-208.1 -44)" />
    ...
    <polygon opacity="0.1" points="350.52 217.98 351.92 67.83 343.23 210.25 350.52 217.98" />
    <path d="M617.78,111.83,616.09,293c-3.11-.67-6.19-1.49-9.21-2.42Z" opacity="0.1"
        transform="translate(-208.1 -44)" />
    <path d="M675.54,111.83l-1.67,179.72c-3.09.87-6.25,1.6-9.43,2.19Z" opacity="0.1"
        transform="translate(-208.1 -44)" />
    <polygon opacity="0.1" points="523.87 211 525.2 67.83 515.96 219.21 523.87 211" />
    <rect height="77.91" opacity="0.1" rx="12" width="239.1" x="322.38" y="137.68" />
    <path d="M760.18,294.52a110,110,0,1,1-4.07-29.77A110.15,110.15,0,0,1,760.18,294.52Z"
        fill="#975656" transform="translate(-208.1 -44)" />
    <path
        ...
        opacity="0.1" transform="translate(-208.1 -44)" />
    <rect fill="#eeeff0" height="77.91" rx="16.12" width="239.1" x="322.38" y="140.37" />
    <polygon opacity="0.1" points="348.8 210.22 351.92 159.18 351.45 210.22 348.8 210.22" />
    <polygon opacity="0.1" points="409.21 210.22 409.68 159.18 406.56 210.22 409.21 210.22" />
    <polygon opacity="0.1" points="467.44 159.18 466.96 210.22 464.32 210.22 467.44 159.18" />
    <polygon opacity="0.1" points="522.08 210.22 525.2 159.18 524.73 210.22 522.08 210.22" />
    <circle cx="400.29" cy="237.09" opacity="0.1" r="14.78" />
    <circle cx="400.29" cy="235.74" fill="#eeeff0" r="14.78" />
    <circle cx="400.29" cy="235.74" fill="#373e46" r="6.72" />
    <circle cx="401.63" cy="233.06" fill="#fff" r="1.34" />
    <circle cx="488.95" cy="237.09" opacity="0.1" r="14.78" />
    <circle cx="488.95" cy="235.74" fill="#eeeff0" r="14.78" />
    <circle cx="488.95" cy="235.74" fill="#373e46" r="6.72" />
    <circle cx="486.26" cy="233.06" fill="#fff" r="1.34" />
    <circle cx="444.62" cy="281.41" opacity="0.1" r="44.33" />
    <circle cx="444.62" cy="278.73" fill="var(--color-primary)" r="44.33" />
    <polygon fill="#373e46"

...
export interface InLoveProps extends SVGProps<SVGSVGElement> {}

export const InLove = (props: InLoveProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="#ffb6b6" id="uuid-afa4718a-41ef-46ad-9f1b-fdedc1410b9c-19" />
    ...
    <path
        ...
        fill="#2f2e41" />
    <circle cx="291.74" cy="49.82" fill="#ffb6b6" r="32.7" />
    <path
    ...
    <path
        ...
        fill="#ffb6b6" id="uuid-b608ab84-b9cd-47a8-808f-666f8f7d666f-20" />
    <polygon fill="var(--color-primary)"
    ...
    <path
        ...
        fill="#ffb6b6" id="uuid-2fb5f450-2303-4fbd-97a7-1c64874c1514-21" />
    <polygon fill="var(--color-primary)"
    ...
    <path
        ...
        fill="#ffb6b6" id="uuid-2ae02034-8b61-43cb-9dde-8a75b258f379-22" />
    <path

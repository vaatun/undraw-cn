...
export interface MindfulnessProps extends SVGProps<SVGSVGElement> {}

export const Mindfulness = (props: MindfulnessProps) => {
  return (
    <svg
    ...
    <circle cx="418.22" cy="117.64" fill="#a0616a" r="55.85" />
    <path
    ...
    <path d="m485.69,231.49s34-12,47,27c13,39,10,71,10,71l-50,16-7-114h0Z"
    ...
    <path
        ...
        fill="#a0616a" />
    <path d="m330.69,231.49s-34-12-47,27c-13,39-10,71-10,71l50,16,7-114h0Z"
        fill="var(--color-primary)" />
    <ellipse cx="578.19" cy="442.49" fill="#a0616a" rx="24" ry="35.5" />
    <ellipse cx="241.19" cy="448.49" fill="#a0616a" rx="24" ry="35.5" />
    <polyline fill="#2f2e41" points="332.84 507.83 419.84 532.83 436.84 562.83 404.33 569.83" />
    </svg>
  )
}

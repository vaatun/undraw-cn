...
export interface VerifiedProps extends SVGProps<SVGSVGElement> {}
...
export const Verified = (props: VerifiedProps) => {
  return (
    ...
    >
      ...
      <g data-name="Group 25" id="Group_25" transform="translate(-228 -105)">
        <ellipse cx="340.5" cy="20" data-name="Ellipse 92" fill="#e6e6e6" id="Ellipse_92" rx="340.5"
            ry="20" transform="translate(228 751.689)" />
        <path
            ...
            data-name="Path 607" fill="#3f3d56" id="Path_607-2135" transform="translate(0 0.345)" />
        <path
            ...
            data-name="Path 608" fill="#fff" id="Path_608-2136" transform="translate(0 0.345)" />
        <path d="M212.286,474.693h-4.493l1.5-87.756h1.5Z" data-name="Path 609" fill="#e6e6e6"
            id="Path_609-2137" transform="translate(184 105)" />
        <path
            ...
            data-name="Path 610" fill="#ccc" id="Path_610-2138" transform="translate(0 0.345)" />
        <path d="M329.245,474.693h-4.493l1.5-87.756h1.5Z" data-name="Path 611" fill="#e6e6e6"
            id="Path_611-2139" transform="translate(184 105)" />
        <path
            ...
            data-name="Path 612" fill="#ccc" id="Path_612-2140" transform="translate(0 0.345)" />
        <circle cx="41.28" cy="41.28" data-name="Ellipse 94" fill="#e6e6e6" id="Ellipse_94"
            r="41.28" transform="translate(351.587 206.238)" />
        <path d="M266.043,461.916H256.78l3.088-180.945h3.087Z" data-name="Path 613" fill="#e6e6e6"
            id="Path_613-2141" transform="translate(184 105)" />
        <path
            ...
            data-name="Path 614" fill="#ccc" id="Path_614-2142" transform="translate(0 0.345)" />
        <path
            ...
            data-name="Path 615" fill="#e6e6e6" id="Path_615-2143"
            transform="translate(6.232 0.345)" />
        <circle cx="63.208" cy="63.208" data-name="Ellipse 95" fill="var(--color-primary)"
            id="Ellipse_95" opacity="0.2" r="63.208" transform="translate(384.812 587.922)" />
        <circle cx="50.895" cy="50.895" data-name="Ellipse 96" fill="var(--color-primary)"
            id="Ellipse_96" r="50.895" transform="translate(397.125 600.235)" />
        <path
            d="M258.084,567.89l-17.937-23.061,10.431-8.113,8.492,10.919,28.689-30.284,9.594,9.088Z"
            data-name="Path 616" fill="#fff" id="Path_616-2144" transform="translate(184 105)" />
        <g data-name="Group 24" id="Group_24">
            <circle cx="33" cy="33" data-name="Ellipse 97" fill="#2f2e41" id="Ellipse_97" r="33"
                transform="translate(685.486 505.969)" />
            <path d="M553.859,383.226l2.542,11.993,47.47-4.1-3.751-17.7Z" data-name="Path 624"
                fill="#ffb8b8" id="Path_624-2145" transform="translate(178 341)" />
            <path d="M789.188,618.5h38.531v14.887H804.075A14.887,14.887,0,0,1,789.188,618.5Z"
                data-name="Path 625" fill="#2f2e41" id="Path_625-2146"
                transform="translate(286.71 1661.973) rotate(-101.965)" />
            <path d="M524.12,382.586l-5.343,11.035-45.1-15.357,7.886-16.285Z" data-name="Path 626"
                fill="#ffb8b8" id="Path_626-2147" transform="translate(178 341)" />
            <path d="M771.037,617.456h23.644v14.887H756.151A14.887,14.887,0,0,1,771.037,617.456Z"
                data-name="Path 627" fill="#2f2e41" id="Path_627-2148"
            ...
            <path
                ...
                data-name="Path 628" fill="#ffb8b8" id="Path_628-2149"
                transform="translate(-77 115.379)" />
            <circle cx="24.561" cy="24.561" data-name="Ellipse 98" fill="#ffb8b8" id="Ellipse_98"
                r="24.561" transform="translate(689.783 524.337)" />
            <path
                ...
                data-name="Path 629" fill="var(--color-primary)" id="Path_629-2150"
                transform="translate(-77 115.379)" />
            <path
                ...
                data-name="Path 630" fill="#2f2e41" id="Path_630-2151"
                transform="translate(-77 115.379)" />
            <path d="M716.486,588.59s17-5,44,8" data-name="Path 631" fill="#2f2e41"
                id="Path_631-2152" transform="translate(-77 115.379)" />
            <path
                ...
                data-name="Path 632" fill="#2f2e41" id="Path_632-2153"
                transform="translate(-77 115.379)" />
            <path
                ...
                data-name="Path 633" fill="#2f2e41" id="Path_633-2154"
                transform="translate(-77 115.379)" />
            <path
                ...
                data-name="Path 636" fill="#ffb8b8" id="Path_636-2155"
                transform="translate(-77 115.379)" />
            <path d="M829.986,459.09h0a9.453,9.453,0,0,1,12.628,5.156l17.372,43.844-27,18Z"
                data-name="Path 637" fill="var(--color-primary)" id="Path_637-2156"
                transform="translate(-77 115.379)" />
        </g>
    </g>
    </svg>

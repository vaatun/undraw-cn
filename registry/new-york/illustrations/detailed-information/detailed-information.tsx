...
export interface DetailedInformationProps extends SVGProps<SVGSVGElement> {}

export const DetailedInformation = (props: DetailedInformationProps) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 1080 639.01401"
      {...props}
    ...
    >
      ...
      <path
        ...
        data-name="Path 103" fill="#e6e6e6" id="a513f258-927a-4de2-b47c-f6d8484aa7b1-2346"
        transform="translate(-60 -130.493)" />
    <path d="M1140,744.493H60v-614H1140Zm-1078-2H1138v-610H62Z" data-name="Path 104" fill="#3f3d56"
        id="b48e35fb-0fa9-4a6e-a77a-d5ee8c8a325a-2347" transform="translate(-60 -130.493)" />
    <circle cx="74" cy="62.99997" data-name="Ellipse 12" fill="var(--color-primary)"
        id="f75cebf4-07f7-4414-ab86-40e5ab2d2599" r="9" />
    <circle cx="101" cy="62.99997" data-name="Ellipse 13" fill="#f2f2f2"
        id="b3bbee1c-ff7e-4047-80a7-543833fb4a02" r="9" />
    <circle cx="128" cy="62.99997" data-name="Ellipse 14" fill="#f2f2f2"
        id="b056dc2b-10c3-4366-8b68-ab2b41800264" r="9" />
    <path d="M1097,642.708v66.785h-71.119A86.746,86.746,0,0,1,1097,642.708Z" data-name="Path 107"
        fill="#e6e6e6" id="b7f9e633-caf8-48cc-9bf3-ee1e6a98fd8b-2348"
        transform="translate(-60 -130.493)" />
    <path
        d="M971.82,313.593l-.64-.77L731.79,511.353l-.77.64,165.87,200h2.6L733.84,512.253l237.08-196.61L1097,467.673v-3.14Z"
        data-name="Path 108" fill="#e6e6e6" id="afff29c9-505b-4418-a373-01de3d3be863-2349"
        transform="translate(-60 -130.493)" />
    <circle cx="704.53398" cy="222.81497" data-name="Ellipse 15" fill="#a0616a"
        id="f8cef931-c3bb-4037-9a50-1e0fdc7c5e4a" r="61.692" />
    <path
        ...
        data-name="Path 111" fill="var(--color-primary)"
        id="a345d496-be51-4ced-87e4-88917a587ade-2350" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 113" fill="#2f2e41" id="a678a244-be81-46d4-9955-cfd6d99b50a8-2351"
        transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 114" fill="var(--color-primary)"
        id="b1de1415-f5bf-440f-a8b8-fa9f905c1360-2352" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 121" fill="#ccc" id="f1868812-8ac7-4b0c-a438-ab55a4a15b12-2353"
        transform="translate(-60 -130.493)" />
    <path d="M1097,711.993H103v-549h994Zm-992.159-1.788h990.31794V164.781H104.841Z"
        data-name="Path 123" fill="#ccc" id="b1b186d5-33ae-41a2-a01c-c43193f01a60-2354"
        transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 122" fill="#3f3d56" id="b98eb8ea-1fd7-4cba-9afb-7866ed7d6078-2355"
        transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 146" fill="#3f3d56" id="a9b170f1-abe6-494b-85b0-d8713abcdd5c-2356"
        transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 141" fill="var(--color-primary)"
        id="b6b39a3c-92e5-4d4e-830c-c9cb70ad8092-2357" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 141-2" fill="var(--color-primary)"
        id="ae94418e-82bb-46b2-bcad-c3c282755a35-2358" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 141-3" fill="var(--color-primary)"
        id="e8feddc1-03fc-4048-aa80-45fc0ee9652e-2359" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 140" fill="#3f3d56" id="bcd0b27f-9e6f-4dd4-9c6b-301806d9c28e-2360"
        transform="translate(-60 -130.493)" />
    <path d="M356,693.493H320v-36h36Zm-34-2h32v-32H322Z" data-name="Path 118" fill="#ff6584"
        id="a4b95a53-3e76-43d9-9905-f39259c2aa97-2361" transform="translate(-60 -130.493)" />
    <path d="M277.185,682.018,264.324,670.23l1.352-1.474,11.139,10.212,25.353-38.03,1.664,1.11Z"
        data-name="Path 119" fill="#3f3d56" id="b5224a29-3e2c-47b8-aafd-f30a3a8a6089-2362"
        transform="translate(-60 -130.493)" />
    <path d="M290,666.493v25H258v-32h25v-2H256v36h36v-27Z" data-name="Path 120" fill="#e5e5e5"
        id="b1af4244-ebcd-4e3e-9659-fd120ece41f1-2363" transform="translate(-60 -130.493)" />
    <circle cx="119.5" cy="438.49997" data-name="Ellipse 18" fill="var(--color-primary)"
        id="aed972d3-7bba-44b7-a5d2-fd1675eb4fbc" r="23.5" />
    <path
        ...
        fill="#a0616a" transform="translate(-60 -130.493)" />
    <path
        ...
        data-name="Path 115" fill="var(--color-primary)"
        id="b4b1ee8f-44c7-4e6a-b1f2-73ec029b7adc-2364" transform="translate(-60 -130.493)" />
    </svg>
  )
}

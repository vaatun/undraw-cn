...
export const Android = (props: AndroidProps) => {
  return (
    <svg
    ...
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-51.45 -46.05)" />
    <path
    ...
    <g opacity="0.1">
        ...
        <path
            ...
            fill="var(--color-primary)" transform="translate(-51.45 -46.05)" />
        <path d="M907.49,475.05c-5.49,6.9-33.9,17-33.9,17s3.42-30,8.91-36.85a16,16,0,0,1,25,19.88Z"
            opacity="0.25" transform="translate(-51.45 -46.05)" />
        <path
            d="M897.74,529.71c-8.36,2.81-37.68-4.18-37.68-4.18s19.15-23.28,27.51-26.09a16,16,0,0,1,10.17,30.27Z"
            opacity="0.25" transform="translate(-51.45 -46.05)" />
        <path
    ...
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-51.45 -46.05)" />
    <rect fill="#535461" height="99" width="7" x="365.51" y="184.9" />
    <rect fill="#535461" height="56" width="7" x="365.51" y="317.9" />
    <rect fill="#535461" height="684" rx="47.1" ry="47.1" width="315" x="370.51" y="87.9" />
    <rect fill="var(--color-primary)" height="623" rx="47.1" ry="47.1" width="315" x="370.51"
        y="119.9" />
    <rect fill="#eaeaf3" height="7" rx="3.5" ry="3.5" width="52" x="502.51" y="102.9" />
    <circle cx="572.51" cy="106.9" fill="#eaeaf3" r="5" />
    <path
        ...
        fill="#fff" transform="translate(-51.45 -46.05)" />
    <rect fill="#535461" height="3" width="65" x="454.01" y="569.46" />
    <rect fill="#535461" height="3" width="43" x="543.01" y="569.46" />
    <rect fill="#535461" height="3" width="43" x="397.01" y="569.46" />
    <rect fill="#535461" height="3" width="43" x="611.01" y="569.46" />
    </svg>
  )
}

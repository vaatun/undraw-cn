...
export interface OnlineMessageProps extends SVGProps<SVGSVGElement> {}

export const OnlineMessage = (props: OnlineMessageProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="#ffb8b8" transform="translate(-125.62999 -121.906)" />
    <ellipse cx="701.12502" cy="651.84399" data-name="Ellipse 432" fill="#e6e6e6"
        id="b78bcc7b-dc51-41b0-8da1-d9ae2dc50050" rx="41.704" ry="4.344" />
    <ellipse cx="824.49801" cy="651.84399" data-name="Ellipse 433" fill="#e6e6e6"
        id="e61ab66d-6414-4e65-834d-738041a766d7" rx="41.704" ry="4.344" />
    <ellipse cx="920.06901" cy="653.20099" data-name="Ellipse 434" fill="#e6e6e6"
        id="b14e1fdf-dcce-4a60-9ebe-71ac2d975d4d" rx="28.671" ry="2.987" />
    <path
        ...
        data-name="Path 2215" fill="#e6e6e6" id="b155b0ed-0d8b-4bf4-9d1d-fec88f99f221-995"
    ...
    <path
        ...
        data-name="Path 2216" fill="#e6e6e6" id="be40ba6a-ff22-46fc-b19c-3116db10fbe1-996"
        transform="translate(-125.62999 -121.906)" />
    <path
        ...
        data-name="Path 2217" fill="#e6e6e6" id="eeaf384e-0545-4292-b8fb-facd94914478-997"
        transform="translate(-125.62999 -121.906)" />
    <path
        ...
        data-name="Path 2218" fill="#3f3d56" id="fa4958e0-769a-4069-95d8-47331dde78e6-998"
        transform="translate(-125.62999 -121.906)" />
    <path
        ...
        data-name="Path 2219" fill="var(--color-primary)"
        id="b96bbff1-710e-4cf9-8f0a-207f6a2454c7-999" transform="translate(-125.62999 -121.906)" />
    <path
        d="M574.021,411.204H376.21a4.2,4.2,0,0,0,0,8.394H574.021a4.2,4.2,0,0,0,.31707-8.394Q574.17962,411.198,574.021,411.204Z"
        data-name="Path 2220" fill="var(--color-primary)"
        id="a99625a5-8e94-4aa2-927a-7cc58a47d0f9-1000" transform="translate(-125.62999 -121.906)" />
    <path d="M461.327,436.384H376.21a4.191,4.191,0,0,0,0,8.382h85.117a4.191,4.191,0,0,0,.014-8.382Z"
        data-name="Path 2221" fill="#e6e6e6" id="f2e8dd5a-2c6f-4c4a-9a4a-91faa08ec764-1001"
        transform="translate(-125.62999 -121.906)" />
    <path
        ...
        data-name="Path 2222" fill="var(--color-primary)"
        id="b0d633b1-50f0-455b-880b-69d0ec30b218-1002" transform="translate(-125.62999 -121.906)" />
    <path
        d="M413.471,271.424a4.2,4.2,0,0,0-.36655,8.392q.18319.008.36655,0H611.278a4.2,4.2,0,0,0,0-8.392Z"
        data-name="Path 2223" fill="#fff" id="a4d76c33-4002-4242-b64e-8bf1a807cbd3-1003"
        transform="translate(-125.62999 -121.906)" />
    <path
        d="M413.471,295.737a4.2,4.2,0,0,0-.36655,8.392q.18319.008.36655,0H611.278a4.2,4.2,0,0,0,0-8.392Z"
        data-name="Path 2224" fill="#fff" id="a4bd9330-30bf-4fe3-97b2-bd8f02deaa7a-1004"
        transform="translate(-125.62999 -121.906)" />
    <path
        d="M413.471,319.754a4.2,4.2,0,0,0,0,8.392h85.117a4.2,4.2,0,1,0,.36655-8.392q-.1832-.008-.36655,0Z"
        data-name="Path 2225" fill="#fff" id="f4033984-e442-4bd8-ab2d-9d91ebc99eb7-1005"
        transform="translate(-125.62999 -121.906)" />
    <circle cx="26.91303" cy="21.33699" data-name="Ellipse 435" fill="var(--color-primary)"
        id="f8f82ae4-70bd-49d3-8148-f9c9501b42d9" r="5.213" />
    <circle cx="45.15802" cy="21.33699" data-name="Ellipse 436" fill="var(--color-primary)"
        id="fa464750-9ca1-4e8d-97b4-cb58e01582d0" r="5.213" />
    <circle cx="63.40302" cy="21.33699" data-name="Ellipse 437" fill="var(--color-primary)"
        id="a6e2f59b-2266-45a7-a68c-25353aee0074" r="5.213" />
    <circle cx="759.87603" cy="225.15999" data-name="Ellipse 438" fill="#ffb8b8"
        id="f535a5d2-8502-4b05-b17c-60a180e2caaa" r="23.221" />
    <path
        ...
        data-name="Path 2228" fill="var(--color-primary)"
        id="a6ce20f5-c5fa-405c-86dd-46bb39d2c055-1006" transform="translate(-125.62999 -121.906)" />
    <path d="M893.886,441.326c13.957,5.34,26.911.7,38.8-14.521l-17.622-34-22.455,4.45Z"
        data-name="Path 2229" fill="var(--color-primary)"
        id="af3567e9-adb8-4eb6-a03d-f215f48a4fbf-1007" transform="translate(-125.62999 -121.906)" />
    <path
        ...
        data-name="Path 2230" fill="#2f2e41" id="bace76f9-9256-4201-a271-96ace1a4e0ec-1008"
        transform="translate(-125.62999 -121.906)" />
    <path
        ...
        fill="#ffb8b8" transform="translate(-125.62999 -121.906)" />
    <path d="M858.015,426.227c9.934,11.164,23.57,13,41.131,4.964V392.897l-21.984-6.382Z"
        data-name="Path 2233" fill="var(--color-primary)"
        id="a8f9c73a-9317-4677-96f1-9f40fb1bc65c-1009" transform="translate(-125.62999 -121.906)" />
    <path
        ...
        fill="#2f2e41" transform="translate(-125.62999 -121.906)" />
    <path

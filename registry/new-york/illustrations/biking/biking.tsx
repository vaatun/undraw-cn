...
export interface BikingProps extends SVGProps<SVGSVGElement> {}

export const Biking = (props: BikingProps) => {
  return (
    <svg
    ...
    <path d="M581.70174,506.22225l-5,112s13,106,10,109-11,9-5,16,28,12,29,8,3-118,3-118l7-135Z"
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <path d="M581.70174,506.22225l-5,112s13,106,10,109-11,9-5,16,28,12,29,8,3-118,3-118l7-135Z"
        opacity="0.2" transform="translate(-131.20174 -123.27775)" />
    <path d="M586.70174,741.22225s-25,19-28,19-30,9-11,13,65,2,66-4-3-24.20866-3-24.20866Z"
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <path d="M586.70174,741.22225s-25,19-28,19-30,9-11,13,65,2,66-4-3-24.20866-3-24.20866Z"
        opacity="0.2" transform="translate(-131.20174 -123.27775)" />
    <path
        d="M524.70174,422.22225s-11,4-11,7-10,41-12,43-3,11-3,11-10,23-8,23,19-4,20,0,9-25,9-25l17-34Z"
        fill="var(--color-primary)" transform="translate(-131.20174 -123.27775)" />
    <path d="M490.70174,510.22225s3,22,11,24,0-28,0-28Z" fill="#ffb8b8"
    ...
    <path
        ...
        fill="#ffb8b8" transform="translate(-131.20174 -123.27775)" />
    <path
        ...
        fill="#3f3d56" transform="translate(-131.20174 -123.27775)" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <circle cx="335.5" cy="561.94451" fill="#2f2e41" r="6" />
    <circle cx="617.5" cy="561.94451" fill="#2f2e41" r="6" />
    <polygon fill="#2f2e41"
    ...
    <rect fill="#2f2e41" height="147.08501"
        transform="translate(-413.07405 460.30478) rotate(-44.4491)" width="1.99988" x="572.2018"
        y="563.17975" />
    <rect fill="#2f2e41" height="1.99993"
        transform="translate(-155.67744 931.13616) rotate(-74.76942)" width="22.80351" x="666.29998"
        y="542.22229" />
    <polygon fill="#2f2e41"
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <rect fill="var(--color-primary)" height="10" width="26" x="450.5" y="567.94451" />
    <path
        ...
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <circle cx="394.5" cy="272.94451" fill="#ffb8b8" r="24" />
    <path
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-131.20174 -123.27775)" />
    <rect fill="#2f2e41" height="6" rx="3"
        transform="translate(68.70297 -267.99528) rotate(19.4707)" width="38" x="502.70174"
        y="507.22225" />
    <path d="M469.70174,500.22225s-35,10-32,21,35-13,35-13Z" fill="#ffb8b8"
        transform="translate(-131.20174 -123.27775)" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-131.20174 -123.27775)" />
    <rect fill="#2f2e41" height="1.99936"
        transform="matrix(0.17975, -0.98371, 0.98371, 0.17975, 65.05255, 1288.53009)"
        width="72.18033" x="908.61157" y="587.22257" />
    <rect fill="#2f2e41" height="98.35141"
        transform="translate(-333.5586 661.65986) rotate(-42.93968)" width="2.00072" x="895.70138"
        y="600.54655" />
    <rect fill="#2f2e41" height="2.00031"
        transform="translate(-310.66012 957.99953) rotate(-54.13715)" width="58.00862" x="939.19743"
        y="715.2221" />
    <circle cx="825" cy="400.44451" fill="var(--color-primary)" r="10" />
    <circle cx="716" cy="477.44451" fill="#3f3d56" r="10" />
    <circle cx="760" cy="487.44451" fill="#3f3d56" r="10" />
    <circle cx="740" cy="526.44451" fill="var(--color-primary)" r="10" />
    <circle cx="865" cy="551.44451" fill="#3f3d56" r="10" />
    <circle cx="832" cy="562.44451" fill="#3f3d56" r="10" />
    <circle cx="855" cy="594.44451" fill="#3f3d56" r="10" />
    <circle cx="750" cy="412.44451" fill="#3f3d56" r="10" />
    <rect fill="#2f2e41" height="2" width="903" y="651.44451" />
    <rect fill="#f2f2f2" height="98" transform="translate(190.95803 -154.42515) rotate(30)"
        width="98" x="170.20174" y="536.5846" />
    <path

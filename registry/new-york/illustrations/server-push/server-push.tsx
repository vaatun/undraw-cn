...
export interface ServerPushProps extends SVGProps<SVGSVGElement> {}

export const ServerPush = (props: ServerPushProps) => {
  return (
    <svg
    ...
    >
      ...
      <path d="M1007.20276,490.067h-519.506V193.71244h519.506Z" fill="#fff"
    ...
    <path
        ...
        fill="#cacaca" transform="translate(-190.79724 -185.44745)" />
    <circle cx="564.64129" cy="163.33526" fill="var(--color-primary)" r="55.49268" />
    <path
        ...
        fill="#fff" transform="translate(-190.79724 -185.44745)" />
    <polygon fill="#cacaca"
    ...
    <path
        ...
        fill="#f0f0f0" transform="translate(-190.79724 -185.44745)" />
    <path
    ...
    <path
        ...
        fill="#a0616a" transform="translate(-190.79724 -185.44745)" />
    <polygon fill="#a0616a"
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-190.79724 -185.44745)" />
    <polygon fill="#a0616a"
    ...
    <path
        ...
        fill="#575a89" transform="translate(-190.79724 -185.44745)" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-190.79724 -185.44745)" />
    <circle cx="254.00773" cy="54.05886" fill="#a0616a" r="26.34173" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-190.79724 -185.44745)" />
    <polygon opacity="0.1" points="234.047 133.571 207.073 173.132 198.447 265.027 234.047 133.571"
    ...
    <path
        ...
        fill="#575a89" transform="translate(-190.79724 -185.44745)" />
    <rect data-name="Rectangle 25-2" fill="#cacaca" height="83.83965"
        id="e8310426-6c31-4dda-9e6e-1765924c3d10"
        transform="translate(-154.75136 673.83032) rotate(-78.2271)" width="101.83965" x="495.51824"
        y="365.55255" />
    <rect data-name="Rectangle 25-3" fill="#fff" height="79.53086"
        id="bd122e35-a1c1-49ee-8743-926b8ce798e5"
        transform="translate(-155.06178 673.23058) rotate(-78.2271)" width="97.53086" x="497.14861"
        y="367.59796" />
    <g data-name="Group 22" id="b64708cb-dce5-48be-ac10-94f92b9c889b">
        <rect data-name="Rectangle 28" fill="#e6e6e6" height="19.96516"
            id="e09379fd-2478-48f1-b81f-f54c4e3c9c7a"
            transform="translate(-118.17691 640.38567) rotate(-78.2271)" width="2.8535"
            x="542.73166" y="358.27592" />
        <rect data-name="Rectangle 29" fill="var(--color-primary)" height="40.62625"
            id="b4bf12c6-107b-4d74-a31b-e84a4ab6c7a8"
            transform="translate(-121.5798 656.81847) rotate(-78.2271)" width="2.8535" x="551.13561"
            y="358.25439" />
        <rect data-name="Rectangle 30" fill="#e6e6e6" height="29.77919"
            id="bbdf33c8-f624-40e0-a78f-3d0040dad156"
            transform="translate(-133.31107 656.04604) rotate(-78.2271)" width="2.8535"
            x="544.79496" y="370.50588" />
        <rect data-name="Rectangle 31" fill="#e6e6e6" height="9.89276"
            id="b44a9e07-be4b-414d-8ba3-c4e4a982d953"
            transform="translate(-149.23695 649.29152) rotate(-78.2271)" width="2.8535"
            x="532.67831" y="386.86549" />
        <rect data-name="Rectangle 32" fill="var(--color-primary)" height="24.09729"
            id="f17ee27a-91b7-41cc-9a5a-26a98e12cdc2"
            transform="translate(-154.70444 662.20638) rotate(-78.2271)" width="2.8535" x="537.8866"
            y="389.5829" />
        <rect data-name="Rectangle 38" fill="#e6e6e6" height="19.96516"
            id="f9a19cfe-d4ee-44fa-ab4d-3d6547ba1e46"
            transform="translate(-165.5447 664.87659) rotate(-78.2271)" width="2.8535" x="534.10852"
            y="399.65032" />
        <rect data-name="Rectangle 39" fill="var(--color-primary)" height="40.62625"
            id="b9542e79-7d8c-492f-96e6-2c189a246911"
            transform="translate(-168.94707 681.30912) rotate(-78.2271)" width="2.8535"
            x="542.51256" y="399.62834" />
        <rect data-name="Rectangle 40" fill="#e6e6e6" height="29.77919"
            id="f3fa939e-a9e2-4fac-b505-074c9ee61dc4"
            transform="translate(-180.67834 680.53669) rotate(-78.2271)" width="2.8535"
            x="536.17191" y="411.87983" />
        <rect data-name="Rectangle 41" fill="#e6e6e6" height="9.89276"
            id="a1de6102-8b84-4497-ba07-467d8fb2348b"
            transform="translate(-196.60472 673.78243) rotate(-78.2271)" width="2.8535"
            x="524.05517" y="428.23988" />
        <rect data-name="Rectangle 42" fill="#e6e6e6" height="24.09729"
            id="be3007b6-c1ef-41ba-b96c-a7356ec98b0f"
            transform="translate(-202.07224 686.69731) rotate(-78.2271)" width="2.8535"
            x="529.26345" y="430.95732" />
    </g>
    <path d="M572.79724,714.55255h-381a1,1,0,0,1,0-2h381a1,1,0,0,1,0,2Z" fill="#cacaca"
        transform="translate(-190.79724 -185.44745)" />
    </svg>
  )
}

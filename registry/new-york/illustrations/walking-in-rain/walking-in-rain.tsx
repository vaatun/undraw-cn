...
export interface WalkingInRainProps extends SVGProps<SVGSVGElement> {}

export const WalkingInRain = (props: WalkingInRainProps) => {
  return (
    <svg
      ...
      role="img"
    >
      <title>Walking In Rain</title>
      <rect fill="#000019" height="352.38" transform="translate(-37.98 167.04) rotate(-30.93)"
        width="4" x="280.93" y="-24.02" />
    <polygon fill="#f3a3a6"
        points="245.05 178.56 268.82 186.38 268.82 152.16 247.25 152.16 245.05 178.56" />
    <circle cx="265.88" cy="137.94" fill="#f3a3a6" r="23.69" />
    <path
        ...
        fill="#2f2e43" />
    <rect fill="#f3a3a6" height="29.71" transform="translate(581.58 1086.85) rotate(-180)"
        width="20.94" x="280.32" y="528.57" />
    <path
        ...
        fill="#2f2e43" />
    <rect fill="#f3a3a6" height="29.71" transform="translate(72.11 1041.25) rotate(-142.5)"
        width="20.94" x="202.3" y="493.53" />
    <path
        ...
        fill="#2f2e43" />
    <path
        d="m0,576.26c0,.66.53,1.19,1.19,1.19h535.26c.66,0,1.19-.53,1.19-1.19s-.53-1.19-1.19-1.19H1.19c-.66,0-1.19.53-1.19,1.19Z"
        fill="#2f2e43" />
    <path
    ...
    <path
        ...
        fill="#f3a3a6" id="uuid-215a2cca-fbee-4bbc-9bf2-8b7e67129ed8-13" />
    <path

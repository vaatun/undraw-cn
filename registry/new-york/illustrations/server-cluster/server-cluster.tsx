...
export interface ServerClusterProps extends SVGProps<SVGSVGElement> {}

export const ServerCluster = (props: ServerClusterProps) => {
  return (
    <svg
    ...
    <rect fill="#2f2e41" height="195" transform="translate(1051.40391 -87.19257) rotate(90)"
        width="262" x="469" y="509.90391" />
    ...
    <rect fill="var(--color-primary)" height="16" width="262" x="313" y="417.90372" />
    <rect fill="var(--color-primary)" height="16" width="262" x="313" y="533.90372" />
    <rect fill="var(--color-primary)" height="16" width="262" x="313" y="649.90372" />
    <circle cx="524" cy="388.80743" fill="var(--color-primary)" r="6" />
    <circle cx="545" cy="388.80743" fill="var(--color-primary)" r="6" />
    <circle cx="566" cy="388.80743" fill="var(--color-primary)" r="6" />
    <circle cx="524" cy="502.80743" fill="var(--color-primary)" r="6" />
    <circle cx="545" cy="502.80743" fill="var(--color-primary)" r="6" />
    <circle cx="566" cy="502.80743" fill="var(--color-primary)" r="6" />
    <circle cx="524" cy="616.80743" fill="var(--color-primary)" r="6" />
    <circle cx="545" cy="616.80743" fill="var(--color-primary)" r="6" />
    <circle cx="566" cy="616.80743" fill="var(--color-primary)" r="6" />
    ...
    <rect fill="var(--color-primary)" height="2.09827" width="56.81724" x="171.14869" y="387.63152" />
    ...
    <rect fill="var(--color-primary)" height="4.19655" width="4.19655" x="154.53324" y="386.58238" />
    ...
    <rect fill="var(--color-primary)" height="2.79582" width="75.70547" x="376.74025" y="67.80733" />
    ...
    <rect fill="var(--color-primary)" height="5.59164" width="5.59164" x="354.60119" y="66.40942" />
    ...
    <rect fill="var(--color-primary)" height="10.44604" width="245.88383" x="321.00559" />
    ...
    <rect fill="var(--color-primary)" height="1.72839" width="46.80151" x="688.84621" y="361.46796" />
    ...
    <rect fill="var(--color-primary)" height="3.45678" width="3.45678" x="675.15972" y="360.60376" />

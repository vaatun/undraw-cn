...
export interface LoveItProps extends SVGProps<SVGSVGElement> {}

export const LoveIt = (props: LoveItProps) => {
  return (
    <svg
    ...
    <path
        ...
        fill="#f6a6a9" id="uuid-91f12725-4651-4192-855e-1b1e45ba96a1-7" />
    <path
        d="m164.52,75.3s-27.46-.72-30.35,6.5c-2.89,7.23-36.85,179.21-36.85,179.21h22.4s44.8-185.71,44.8-185.71Z"
        fill="#dddedf" />
    <circle cx="170.35" cy="38.01" fill="#f6a6a9" r="24.21" />
    <path
    ...
    <path
        ...
        fill="#f6a6a9" id="uuid-8411e106-0120-401a-9ba4-6dca08ef376d-8" />
    <polygon fill="#dddedf"

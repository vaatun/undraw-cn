...
export interface MedicineProps extends SVGProps<SVGSVGElement> {}

export const Medicine = (props: MedicineProps) => {
  return (
    <svg
    ...
    >
      ...
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse"
            id="ac3cc305-f6db-42f4-bbbd-32121ee27a74-2540" x1="403.57" x2="403.57" y1="833.5"
            y2="218.16">
            <stop offset="0" stop-color="gray" stop-opacity="0.25" />
            <stop offset="0.54" stop-color="gray" stop-opacity="0.12" />
            <stop offset="1" stop-color="gray" stop-opacity="0.1" />
        </linearGradient>
        <linearGradient href="#ac3cc305-f6db-42f4-bbbd-32121ee27a74-2540"
            id="ad14f186-b27f-416c-b629-0bafa2f1236e-2541" x1="940.67" x2="940.67" y1="825.72"
            y2="263.72" />
    </defs>
    <title>
        medicine
    </title>
    <ellipse cx="367.38" cy="766.65" fill="var(--color-primary)" opacity="0.1" rx="97.44" ry="15.65" />
    <ellipse cx="897.05" cy="767.09" fill="var(--color-primary)" opacity="0.1" rx="121.59"
        ry="15.65" />
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    ...
    <path
        d="M61.08,396.83H162.57V535.16H68.51c-.25,1.42-.49,2.85-.75,4.28h94.81V651c-.17-.05-.32-.11-.48-.17-2.68-1.06-5.34-2.18-8-3.38l-1.7-.77q-4-1.89-8-4c-.93-.49-1.86-1-2.78-1.52A166.42,166.42,0,0,1,101.73,610c-.34-.33-.66-.68-1-1-1.62-1.76-3.21-3.54-4.75-5.36l-1.7-2c-1.82-2.23-3.58-4.52-5.29-6.84-.25-.34-.49-.68-.75-1a148.88,148.88,0,0,1-17.2-31.1c-.14-.33-.26-.69-.39-1Q68.59,556.4,67,551c-.46-1.51-.9-3-1.28-4.57-.14-.46-.26-.91-.37-1.36C59.67,522.9,59,499.87,59,477c0-2.67,0-5.35,0-8,0-9.25.11-18.56.27-27.86,0-2.41.1-4.81.15-7.23q.21-9.21.6-18.42c.06-1.71.14-3.41.23-5.11q0-1.47.15-2.94C60.64,403.88,60.84,400.35,61.08,396.83Z"
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <polygon fill="var(--color-primary)" opacity="0.1"
    ...
    <rect fill="var(--color-primary)" height="138.33" opacity="0.1" width="76.3" x="139.57"
        y="338.19" />
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <rect fill="var(--color-primary)" height="139.35" opacity="0.1" width="62.92" x="629.96"
        y="194.56" />
    <polygon fill="var(--color-primary)" opacity="0.1"
    ...
    <path d="M1152.27,535.16h-55.7V419.55h30.14C1142.31,456,1152.22,496,1152.27,535.16Z"
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <rect fill="var(--color-primary)" height="43.69" opacity="0.1" width="33.71" x="659.18"
        y="233.3" />
    <rect fill="var(--color-primary)" height="10.06" opacity="0.1" width="33.71" x="659.18"
        y="323.86" />
    <rect fill="var(--color-primary)" height="29.35" opacity="0.1" width="33.71" x="659.18"
        y="338.19" />
    <rect fill="var(--color-primary)" height="43.69" opacity="0.1" width="33.71" x="659.18"
        y="414.42" />
    <rect fill="var(--color-primary)" height="43.69" opacity="0.1" width="33.71" x="659.18"
    ...
    <path d="M740.12,687.7c.34,0,.67,0,1,.06l-1,0v10.15h-33.7V654.17h33.7Z"
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <path d="M740.12,744.71v33.75q-16.9-1.43-33.7-3.89V744.71Z" fill="var(--color-primary)"
        opacity="0.1" transform="translate(-47.24 -58.63)" />
    <rect fill="var(--color-primary)" height="3.21" opacity="0.1" width="144.47" x="380.58"
        y="473.32" />
    <rect fill="var(--color-primary)" height="12.3" opacity="0.1" width="144.47" x="380.58"
        y="480.8" />
    <rect fill="var(--color-primary)" height="19.78" opacity="0.1" width="144.47" x="380.58"
        y="533.42" />
    <path d="M572.28,652.15v19.78h-113q-7.36-5.62-14.54-11.54c-3.31-2.73-6.59-5.53-9.93-8.24Z"
        fill="var(--color-primary)" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <path d="M572.28,712.24V732H560.35q-20.11-9.07-39.43-19.79Z" fill="var(--color-primary)"
        opacity="0.1" transform="translate(-47.24 -58.63)" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="775.83"
        y="351.6" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="160.05"
        y="219.09" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="160.05"
        y="285.15" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="160.05"
    ...
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="160.05"
        y="549.38" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="884.4" y="351.6" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="775.83"
        y="421.75" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="884.4"
        y="421.75" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="775.83"
        y="491.89" />
    <rect fill="var(--color-primary)" height="28.44" opacity="0.1" width="28.44" x="884.4"
    ...
    <path
        ...
        fill="url(#ac3cc305-f6db-42f4-bbbd-32121ee27a74-2540)" transform="translate(-47.24 -58.63)" />
    <path d="M486.8,513.74l-2.16,9.2s-17.3-8.83-20.42-20.05,5.22-15.48,5.22-15.48l16.12,6.83Z"
        fill="#fff" transform="translate(-47.24 -58.63)" />
    <path d="M486.8,513.74l-2.16,9.2s-17.3-8.83-20.42-20.05,5.22-15.48,5.22-15.48l16.12,6.83Z"
        opacity="0.1" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#cf6f80" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#cf6f80" transform="translate(-47.24 -58.63)" />
    <circle cx="365.11" cy="328.48" opacity="0.1" r="2.7" />
    <circle cx="365.11" cy="327.38" fill="#3f3d56" r="2.7" />
    <circle cx="370.08" cy="445.36" opacity="0.1" r="2.7" />
    <circle cx="370.08" cy="444.25" fill="#3f3d56" r="2.7" />
    <circle cx="367.8" cy="386.92" opacity="0.1" r="2.7" />
    <circle cx="367.8" cy="385.82" fill="#3f3d56" r="2.7" />
    <path
    ...
    <path
        ...
        fill="#512e4e" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#fff" transform="translate(-47.24 -58.63)" />
    <path d="M360.15,778.56s9.66-6.07,16-1.66S360.15,778.56,360.15,778.56Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <path d="M435.21,759.79s8.55-1.1,15.73,6.63S435.21,759.79,435.21,759.79Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <g opacity="0.1">
        <path
    ...
    <ellipse cx="132.73" cy="744.94" fill="var(--color-primary)" opacity="0.1" rx="97.44" ry="15.65" />
    <rect fill="#535461" height="141.17" width="6.27" x="129.6" y="445.14" />
    <path
        ...
        fill="#3f3d56" transform="translate(-47.24 -58.63)" />
    <polygon fill="#9d9cb5"
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-47.24 -58.63)" />
    <path d="M47.72,528.76s45.68,25.35,60.33,46.34S180,624.42,180,624.42" fill="none"
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-47.24 -58.63)" />
    <path d="M108,488.26s24.86,13.8,32.83,25.22S180,540.32,180,540.32" fill="none" stroke="#535461"
        stroke-miterlimit="10" stroke-width="2" transform="translate(-47.24 -58.63)" />
    <path
        ...
        fill="var(--color-primary)" transform="translate(-47.24 -58.63)" />
    <path d="M263.87,506.19s-29.74,25.72-37.3,43.44-45.38,47.43-45.38,47.43" fill="none"
        stroke="#535461" stroke-miterlimit="10" stroke-width="2"
        transform="translate(-47.24 -58.63)" />
    <path
        ...
        fill="url(#ad14f186-b27f-416c-b629-0bafa2f1236e-2541)" transform="translate(-47.24 -58.63)" />
    <polygon fill="#1d2366"
    ...
    <path
        ...
        fill="#ffb0b1" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#1d2366" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#1d2366" transform="translate(-47.24 -58.63)" />
    <path d="M876,439s-14,15-3.4,23.36,17.57.8,17.57.8Z" fill="#c7daf5"
        transform="translate(-47.24 -58.63)" />
    <path d="M876,439s-14,15-3.4,23.36,17.57.8,17.57.8Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        d="M930.51,406.26s-2.39,5-7.19,4.19-4.79,18-4.79,18-3.19,3-5.39.4-8,6.19-8,6.19l-36.34,1.6s16.17,7.39,13,29.75c0,0,54.9-3.4,56.7-8.59S930.51,406.26,930.51,406.26Z"
        opacity="0.03" transform="translate(-47.24 -58.63)" />
    <polygon fill="#fff"
    ...
    <path
        ...
        fill="#fff" transform="translate(-47.24 -58.63)" />
    <path d="M919.93,486.72s-23-1-34.14-14.38S911.54,467,911.54,467l9.59,2.2Z" fill="#ffb0b1"
        transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#fff" transform="translate(-47.24 -58.63)" />
    <path d="M999.59,459s-15-3-9.78,2,5.19,9.38,11.58,9.18S999.59,459,999.59,459Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <path d="M1024.94,566.58s-6.78,4.59,6.19,15.17S1024.94,566.58,1024.94,566.58Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <path d="M1012,604.31c0,.6-2.4,22,6.58,27.35S1012,604.31,1012,604.31Z" opacity="0.1"
        transform="translate(-47.24 -58.63)" />
    <path
        d="M869.42,436.59c-7.24.25-22.88,2.46-14.77,17.59,7.17,13.39,19.22,4.44,26-2.35A25.55,25.55,0,0,0,869.42,436.59Z"
        fill="#ffb0b1" transform="translate(-47.24 -58.63)" />
    <path d="M881.39,451v0Z" fill="#ffb0b1" transform="translate(-47.24 -58.63)" />
    <path d="M880.74,451.71l.3-.31Z" fill="#ffb0b1" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#dce7ff" transform="translate(-47.24 -58.63)" />
    ...
    <path
        ...
        fill="#591d4b" transform="translate(-47.24 -58.63)" />
    <path
    ...
    <path
        ...
        fill="#be8b87" transform="translate(-47.24 -58.63)" />
    <path
        ...
        fill="#fff" opacity="0.1" transform="translate(-47.24 -58.63)" />
    <polygon fill="#efc8c4"
    ...
    <path
        ...
        fill="#727a9c" transform="translate(-47.24 -58.63)" />
    <path d="M861.13,441.7s17.37-.1,13.28,7.29-10.48,8.28-10.48,8.28Z" fill="#ffb0b1"
        transform="translate(-47.24 -58.63)" />
    <path

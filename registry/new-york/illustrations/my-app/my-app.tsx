...
export interface MyAppProps extends SVGProps<SVGSVGElement> {}
...
export const MyApp = (props: MyAppProps) => {
  return (
    ...
    >
      <title>My App</title>
      <g data-name="Group 6" id="Group_6" transform="translate(-231.222 -125)">
        <path
            ...
            data-name="Path 80" fill="#3f3d56" id="Path_80-1961" transform="translate(-0.099 0.231)" />
        <path
            ...
            data-name="Path 81" fill="#fff" id="Path_81-1962" transform="translate(-0.099 0.231)" />
        <path
            ...
            data-name="Path 93" fill="#e6e6e6" id="Path_93-1963" transform="translate(-0.099 0.231)" />
        <path
            ...
            data-name="Path 94" fill="#e6e6e6" id="Path_94-1964" transform="translate(-0.099 0.465)" />
        <path
            ...
            data-name="Path 95" fill="#e6e6e6" id="Path_95-1965" transform="translate(-0.099 0.454)" />
        <path
            ...
            data-name="Path 96" fill="#e6e6e6" id="Path_96-1966" transform="translate(-0.099 0.454)" />
        <path
            ...
            data-name="Path 79" fill="#e6e6e6" id="Path_79-1967" transform="translate(64.123 3.512)" />
        <path
            ...
            data-name="Path 97" fill="var(--color-primary)" id="Path_97-1968"
        ...
        <path
            ...
            data-name="Path 111" fill="#a0616a" id="Path_111-1969"
            transform="translate(55.741 19.97)" />
        <path d="M69.534,574.966l12.075,2.123,11.934-45.564-15.821-3.133Z" data-name="Path 112"
            fill="#a0616a" id="Path_112-1970" transform="translate(340 173)" />
        <path d="M350.232,727.314h38.531V742.2H365.119a14.887,14.887,0,0,1-14.887-14.887Z"
            data-name="Path 113" fill="#2f2e41" id="Path_113-1971"
            transform="translate(661.936 1542.365) rotate(-170.029)" />
        <path d="M36.392,581.01h12.26l5.832-47.288H36.39Z" data-name="Path 114" fill="#a0616a"
            id="Path_114-1972" transform="translate(340 173)" />
        <path d="M318.024,730.536h38.531v14.887H332.911a14.887,14.887,0,0,1-14.887-14.887h0Z"
            data-name="Path 115" fill="#2f2e41" id="Path_115-1973"
        ...
        <path
            ...
            data-name="Path 116" fill="#2f2e41" id="Path_116-1974"
            transform="translate(55.741 19.97)" />
        <circle cx="24.561" cy="24.561" data-name="Ellipse 16" fill="#a0616a" id="Ellipse_16"
            r="24.561" transform="translate(373.568 371.694)" />
        <path
            ...
            data-name="Path 117" fill="var(--color-primary)" id="Path_117-1975"
            transform="translate(55.741 19.97)" />
        <path
        ...
        <path
            ...
            data-name="Path 120" fill="var(--color-primary)" id="Path_120-1978"
            transform="translate(55.741 19.97)" />
        <path
            ...
            data-name="Path 121" fill="#2f2e41" id="Path_121-1979"
            transform="translate(55.741 19.97)" />
    </g>
    </svg>
  )

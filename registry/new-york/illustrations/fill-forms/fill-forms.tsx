...
export interface FillFormsProps extends SVGProps<SVGSVGElement> {}

export const FillForms = (props: FillFormsProps) => {
  return (
    <svg
    ...
    >
      ...
      <g data-name="Group 47" id="Group_47" transform="translate(-171.808 -222.403)">
        <g data-name="Group 43" id="Group_43" transform="translate(-222.485 -67.725)">
            ...
            <circle cx="36.956" cy="36.956" data-name="Ellipse 115" fill="var(--color-primary)"
                id="Ellipse_115" r="36.956" transform="translate(394.293 291.029)" />
            <circle cx="36.956" cy="36.956" data-name="Ellipse 116" fill="#3f3d56" id="Ellipse_116"
            ...
            <path
                ...
                data-name="Path 748" fill="#ccc" id="Path_748-1603"
            ...
            <path
                ...
                data-name="Path 749" fill="#ccc" id="Path_749-1604"
            ...
            <path
                ...
                data-name="Path 395" fill="#fff" id="Path_395-1605"
        ...
        <g data-name="Group 24" id="Group_24" transform="translate(808.073 222.403)">
            <path
                ...
                data-name="Path 552" fill="#feb8b8" id="Path_552-1606"
                transform="translate(-293.875 -349.453)" />
            <path d="M312.83,797.912H295.567l-8.212-66.584h25.477Z" data-name="Path 553"
                fill="#feb8b8" id="Path_553-1607" transform="translate(-190.709 -256.191)" />
            <path d="M305.692,775.115h33.292v20.955H284.73a20.962,20.962,0,0,1,20.962-20.962h0Z"
                data-name="Path 554" fill="#2f2e41" id="Path_554-1608"
                transform="translate(-213.164 -238.326)" />
            <path d="M271.557,794.354l-17.178,1.69-14.7-65.458,25.355-2.491Z" data-name="Path 555"
                fill="#feb8b8" id="Path_555-1609" transform="translate(-82.3 -257.51)" />
            <path
                d="M254.863,774.674l33.126-3.263,2.054,20.857-53.981,5.317a20.958,20.958,0,0,1,18.8-22.911Z"
                data-name="Path 556" fill="#2f2e41" id="Path_556-1610"
                transform="translate(-95.55 -239.834)" />
            <ellipse cx="34.583" cy="34.583" data-name="Ellipse 84" fill="#feb8b8" id="Ellipse_84"
                rx="34.583" ry="34.583" transform="translate(92.343 13.688)" />
            <path
                ...
                data-name="Path 557" fill="#2f2e41" id="Path_557-1611"
            ...
            <path
                ...
                data-name="Path 99" fill="#e6e6e6" id="Path_99-1612"
            ...
            <path
                ...
                data-name="Path 558" fill="#feb8b8" id="Path_558-1613"
            ...
            <path
                ...
                data-name="Path 101" fill="#e6e6e6" id="Path_101-1614"
            ...
            <path
                ...
                data-name="Path 102" fill="#2f2e41" id="Path_102-1615"
        ...
        <path
            ...
            data-name="Path 438" fill="#e6e6e6" id="Path_438-1616"
        ...
        <path
            ...
            data-name="Path 439" fill="#f2f2f2" id="Path_439-1617"
        ...
        <path
            ...
            data-name="Path 442" fill="#e6e6e6" id="Path_442-1618"
        ...
        <path
            ...
            data-name="Path 443" fill="#f2f2f2" id="Path_443-1619"
        ...
        <g data-name="Group 46" id="Group_46" transform="translate(2 7)">
            <path
                ...
                data-name="Path 138" fill="#e6e6e6" id="Path_138-1620"
                transform="translate(-108.981 -172.87)" />
            <path d="M690.369,556.72a3.969,3.969,0,1,0,0,7.938H877.477a3.969,3.969,0,0,0,0-7.938Z"
                data-name="Path 139" fill="#e6e6e6" id="Path_139-1621"
                transform="translate(-99.78 -170.602)" />
            <path d="M690.369,578.466a3.969,3.969,0,1,0,0,7.938h80.513a3.969,3.969,0,1,0,0-7.938Z"
                data-name="Path 140" fill="#e6e6e6" id="Path_140-1622"
                transform="translate(-99.78 -168.533)" />
            <g data-name="Group 45" id="Group_45">
                <circle cx="23.814" cy="23.814" data-name="Ellipse 18" fill="#e6e6e6"
                    id="Ellipse_18" r="23.814" transform="translate(512 378)" />
                <path
                    ...
                    data-name="Path 395" fill="var(--color-primary)" id="Path_395-2-1623"

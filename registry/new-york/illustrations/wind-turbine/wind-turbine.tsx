...
export interface WindTurbineProps extends SVGProps<SVGSVGElement> {}

export const WindTurbine = (props: WindTurbineProps) => {
  return (
    <svg
    ...
    >
      ...
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse"
            id="e9df2e8e-6999-41c4-9621-44bffc2f2623-2542" x1="241.37" x2="241.37" y1="811.22"
            y2="492.1">
    ...
    <path
        ...
        fill="var(--color-primary)" opacity="0.1" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="40.51" width="18.94" x="548.06" y="218.5" />
    <rect fill="#fff" height="17.78" width="14.57" x="550.39" y="249.39" />
    <path d="M586.05,157.64c-6.63-1.93-11.14-.46-14,1.39l1.21-43.7s6.38-12.09,12.73,42.11Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M595,317v28.4H576.06V317.56A25.6,25.6,0,0,1,595,317Z" fill="var(--color-primary)"
    ...
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="40.51" transform="translate(-19.51 680.17) rotate(-64)" width="18.94"
        x="608.15" y="356.23" />
    <rect fill="#fff" height="17.78" transform="translate(1165.83 -96.27) rotate(116)" width="14.57"
        x="592.72" y="359.16" />
    <path d="M767.93,450.38c4.64-5.12,5.3-9.82,4.88-13.17l38.75,20.24s8.06,11-43.44-7Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M620.79,388.56l-25.53-12.45,8.3-17,25,12.2A25.59,25.59,0,0,1,620.79,388.56Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="18.94" transform="translate(-137.03 194.33) rotate(-26)" width="40.51"
        x="533.19" y="367.01" />
    <rect fill="#fff" height="17.78" transform="translate(623.52 -392.94) rotate(64)" width="14.57"
        x="563.77" y="359.16" />
    <path d="M403.13,450.38c-4.64-5.12-5.3-9.82-4.88-13.17L359.5,457.45s-8.06,11,43.44-7Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M550.27,388.56l25.53-12.45-8.3-17-25,12.2A25.59,25.59,0,0,0,550.27,388.56Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <polygon fill="#fff"
        points="574.57 717.37 537.42 717.37 549.22 279.84 562.77 279.84 574.57 717.37" />
    <circle cx="557.53" cy="274.45" fill="var(--color-primary)" r="12.38" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="27.41" width="12.81" x="832.05" y="191.22" />
    <rect fill="#fff" height="12.03" width="9.86" x="833.62" y="212.12" />
    <path d="M866.81,178c-4.49-1.3-7.54-.31-9.45.94l.81-29.56s4.32-8.18,8.62,28.49Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M872.86,285.8V305H860.05V286.19A17.29,17.29,0,0,1,872.86,285.8Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="27.41" transform="translate(177.76 895.01) rotate(-64)" width="12.81"
        x="881.76" y="312.35" />
    <rect fill="#fff" height="12.03" transform="translate(1520.3 -413.17) rotate(116)" width="9.86"
        x="871.32" y="314.33" />
    <path d="M989.86,376.05c3.14-3.46,3.59-6.64,3.3-8.91l26.21,13.69s5.46,7.47-29.38-4.74Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M890.31,334.23,873,325.8l5.61-11.51,16.93,8.25A17.35,17.35,0,0,1,890.31,334.23Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="12.81" transform="translate(-85.44 316.93) rotate(-26)" width="27.41"
        x="831.05" y="319.65" />
    <rect fill="#fff" height="12.03" transform="translate(741.05 -676.43) rotate(64)" width="9.86"
        x="851.73" y="314.33" />
    <path d="M743.05,376.05c-3.14-3.46-3.59-6.64-3.3-8.91l-26.21,13.69s-5.46,7.47,29.38-4.74Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M842.6,334.23l17.27-8.43-5.61-11.51-16.93,8.25A17.35,17.35,0,0,0,842.6,334.23Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <polygon fill="#fff" points="849.99 528.74 824.73 533.18 832.83 232.73 842 232.73 849.99 528.74" />
    <circle cx="838.46" cy="229.08" fill="var(--color-primary)" r="8.38" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="27.41" width="12.81" x="258.89" y="191.22" />
    <rect fill="#fff" height="12.03" width="9.86" x="260.46" y="212.12" />
    <path d="M293.65,178c-4.48-1.3-7.54-.31-9.45.94l.81-29.56s4.32-8.18,8.62,28.49Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M299.7,285.8V305H286.89V286.19A17.29,17.29,0,0,1,299.7,285.8Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="27.41" transform="translate(-144.14 379.86) rotate(-64)" width="12.81"
        x="308.6" y="312.35" />
    <rect fill="#fff" height="12.03" transform="translate(695.88 101.98) rotate(116)" width="9.86"
        x="298.16" y="314.33" />
    <path d="M416.7,376.05c3.14-3.46,3.59-6.64,3.3-8.91l26.22,13.69s5.45,7.47-29.39-4.74Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M317.15,334.23l-17.27-8.43,5.62-11.51,16.92,8.25A17.31,17.31,0,0,1,317.15,334.23Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <rect fill="#fff" height="12.81" transform="translate(-143.45 65.67) rotate(-26)" width="27.41"
        x="257.89" y="319.65" />
    <rect fill="#fff" height="12.03" transform="translate(419.15 -161.28) rotate(64)" width="9.86"
        x="278.58" y="314.33" />
    <path d="M169.89,376.05c-3.13-3.46-3.58-6.64-3.3-8.91l-26.21,13.69s-5.46,7.47,29.38-4.74Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <path d="M269.44,334.23l17.27-8.43-5.61-11.51-16.93,8.25A17.4,17.4,0,0,0,269.44,334.23Z"
        fill="var(--color-primary)" transform="translate(-28 -86.39)" />
    <polygon fill="#fff"
        points="276.83 528.74 251.69 528.74 259.68 232.73 268.84 232.73 276.83 528.74" />
    <circle cx="265.3" cy="229.08" fill="var(--color-primary)" r="8.38" />
    <path
        ...
        fill="#fff" transform="translate(-28 -86.39)" />
    <ellipse cx="209.13" cy="712.91" fill="var(--color-primary)" opacity="0.1" rx="121.92"
        ry="14.31" />
    <path
        ...
        fill="url(#e9df2e8e-6999-41c4-9621-44bffc2f2623-2542)" transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#65617d" transform="translate(-28 -86.39)" />
    <path d="M271.2,783.18s0,8.56,6.25,8.4,7.09-3.41,5.11-5.61a27,27,0,0,1-3.46-5.09Z" opacity="0.1"
        transform="translate(-28 -86.39)" />
    <path
        ...
        fill="#65617d" transform="translate(-28 -86.39)" />
    <path d="M186.1,770.78a1.64,1.64,0,0,1-.82.06A2.42,2.42,0,0,1,186.1,770.78Z" fill="#444053"
        transform="translate(-28 -86.39)" />
    <path d="M203.72,780.55s.06,2,0,4.44l-18.4-3s.09-.35.22-.93c1.47-1.75,2.58-2.85,2.58-2.85Z"
    ...
    <path
        ...
        fill="#444053" transform="translate(-28 -86.39)" />
    <path
    ...
    <path
        ...
        opacity="0.1" transform="translate(-28 -86.39)" />
    <path d="M222.84,713.55a10.18,10.18,0,0,0-5.62-1.84A8,8,0,0,1,222.84,713.55Z" opacity="0.1"
        transform="translate(-28 -86.39)" />
    <path
    ...
    <path
        ...
        opacity="0.1" transform="translate(-28 -86.39)" />
    <path d="M262,520a18.76,18.76,0,1,1-5.66-13.43A18.62,18.62,0,0,1,262,520Z" fill="#fbbebe"
        transform="translate(-28 -86.39)" />
    <path
    ...
    <path
        ...
        fill="#65617d" transform="translate(-28 -86.39)" />
    <path d="M264.12,658.42l5.93,5.78s5.43,18.74-1.65,17.1-13-12-13-12Z" fill="#fbbebe"
        transform="translate(-28 -86.39)" />
    <path

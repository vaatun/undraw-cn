...
export interface SeasonChangeProps extends SVGProps<SVGSVGElement> {}

export const SeasonChange = (props: SeasonChangeProps) => {
  return (
    <svg
      ...
      role="img"
    >
      <title>Season Change</title>
      <title>
        season_change
    </title>
    <circle cx="73.89615" cy="71.32961" fill="#ff6584" r="46" />
    <ellipse cx="444.00318" cy="522.80203" fill="#e6e6e6" rx="444.00318" ry="18" />
    <circle cx="113" cy="184.2194" fill="var(--color-primary)" r="113" />
    <polygon fill="#3f3d56" points="123.892 524.581 100.747 524.581 111.298 167.201 123.892 524.581" />
    <polygon fill="#3f3d56"
    ...
    <polygon fill="#3f3d56" points="827.505 524.957 804.361 524.957 814.912 167.577 827.505 524.957" />
    <polygon fill="#3f3d56"
    ...
    <circle cx="459.05561" cy="314.39327" fill="#3f3d56" r="210.50358" />
    <circle cx="459.05561" cy="314.39327" fill="#fff" r="193.07779" />
    <circle cx="458.35857" cy="315.0903" fill="#3f3d56" r="25.79017" />
    <rect fill="#3f3d56" height="20.91095" width="11.15251" x="452.78232" y="131.07392" />
    <rect fill="#3f3d56" height="20.91095" width="11.15251" x="452.78232" y="478.19572" />
    <rect fill="#3f3d56" height="20.91095" transform="translate(779.48696 -123.40042) rotate(90)"
        width="11.15251" x="432.91447" y="484.23381" />
    <rect fill="#3f3d56" height="20.91095" transform="translate(1126.60876 -470.52223) rotate(90)"
        width="11.15251" x="780.03627" y="484.23381" />
    <polygon fill="#3f3d56" points="450.924 326.286 460.455 304.493 579.88 370.635 450.924 326.286" />
    <rect fill="#3f3d56" height="62.73286" width="54.36848" x="431.87137" y="53.00636" />
    <ellipse cx="459.05561" cy="53.00636" fill="#3f3d56" rx="62.73286" ry="17.42579" />
    <path
        ...
        fill="#ffb8b8" transform="translate(-153.69305 -179.59899)" />
    <path
        ...
        fill="#ffb8b8" transform="translate(-153.69305 -179.59899)" />
    <circle cx="660.03348" cy="254.04245" fill="#2f2e41" r="21.22425" />
    <path
    ...
    <path
        ...
        fill="var(--color-primary)" transform="translate(-153.69305 -179.59899)" />
    <circle cx="657.70965" cy="260.02479" fill="#ffb8b8" r="16.03173" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-153.69305 -179.59899)" />
    <path
    ...
    <path
        ...
        fill="#2f2e41" transform="translate(-153.69305 -179.59899)" />
    <circle cx="667.45803" cy="231.7041" fill="#2f2e41" r="8.78245" />
    <path
        ...
        fill="#2f2e41" transform="translate(-153.69305 -179.59899)" />
    <ellipse cx="657.56451" cy="249.54235" fill="#2f2e41" rx="14.63741" ry="8.78245" />
    <path
        ...
        fill="#e6e6e6" transform="translate(-153.69305 -179.59899)" />
    <circle cx="771.6139" cy="124.178" fill="#e6e6e6" r="12" />
    <circle cx="807.84695" cy="95.88566" fill="#e6e6e6" r="9.9918" />
    <circle cx="856.6139" cy="150.178" fill="#e6e6e6" r="12" />
    <circle cx="765.6139" cy="205.178" fill="#e6e6e6" r="12" />
    <circle cx="856.6139" cy="274.178" fill="#e6e6e6" r="12" />
    <path
        ...
        fill="#e6e6e6" transform="translate(-153.69305 -179.59899)" />
    <circle cx="867.6139" cy="226.178" fill="#e6e6e6" r="5" />
    <circle cx="835.6139" cy="106.178" fill="#e6e6e6" r="5" />
    <circle cx="818.6139" cy="230.178" fill="#e6e6e6" r="5" />
    <circle cx="822.6139" cy="225.178" fill="#e6e6e6" r="5" />
    <circle cx="825.6139" cy="220.178" fill="#e6e6e6" r="5" />
    <circle cx="813.6139" cy="262.178" fill="#e6e6e6" r="5" />
    <circle cx="887.6139" cy="318.178" fill="#e6e6e6" r="5" />
    <circle cx="780.6139" cy="321.178" fill="#e6e6e6" r="5" />
    <circle cx="786.6139" cy="167.178" fill="#e6e6e6" r="5" />
    <circle cx="809.6139" cy="257.178" fill="#e6e6e6" r="5" />
    <circle cx="804.6139" cy="249.178" fill="#e6e6e6" r="5" />
    </svg>
  )
}
